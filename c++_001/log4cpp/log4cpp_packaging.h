...
#define logError(msg)  (Mylogerror(__FILE__,__func__,__LINE__,msg))
#define logDebug(msg)  (Mylogdebug(__FILE__,__func__,__LINE__,msg))
#define logInfo(msg)  (Myloginfo(__FILE__,__func__,__LINE__,msg))
