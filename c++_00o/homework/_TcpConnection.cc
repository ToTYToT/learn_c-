 ///
 /// @file    _TcpConnection.cc
 /// @author  ToTYToT(hongzimeng@foxmail.com)
 /// @date    2016-11-23 22:25:09
 ///
...
namespace wd
{
	...
	{
		char text[100];
		snprintf(text,sizeof text,"%s:%d -> %s:%d",_localAddr.toIp().c_str(),_localAddr.toPort(),_peerAddr.toIp().c_str(),_peerAddr.toPort());
		return text;
	}
}
